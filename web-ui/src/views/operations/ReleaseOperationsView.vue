...
<template>
  <div class="console-page release-page" v-loading="loading">
    ...
    <section v-else-if="activeTab === 'traces'" class="ops-band">
      ...
      <pre v-if="replayResult" class="replay-output">{{ JSON.stringify(replayResult, null, 2) }}</pre>
    </section>
...
.ops-summary p { min-width: 0; display: flex; flex-direction: column; }.ops-summary small { color: #78838a; font-size: 9px; }.ops-summary strong { margin-top: 10px; color: #f2f6f3; font-size: 23px; }.ops-summary em { margin-top: 4px; color: #626d74; font-size: 8px; font-style: normal; }
.ops-tabs { margin-top: 18px; display: flex; gap: 2px; border-bottom: 1px solid var(--ops-line); overflow-x: auto; }.ops-tabs button { min-height: 42px; padding: 0 17px; border: 0; border-bottom: 2px solid transparent; background: transparent; color: #747f86; font: inherit; font-size: 10px; white-space: nowrap; cursor: pointer; }.ops-tabs button.active { border-color: var(--ops-green); color: #e9f2ec; background: #121a16; }
.ops-band { min-height: 540px; border: 1px solid var(--ops-line); border-top: 0; background: #0e1215; }.ops-band > header { min-height: 72px; padding: 0 18px; display: flex; align-items: center; justify-content: space-between; gap: 14px; border-bottom: 1px solid var(--ops-line); }.ops-band > header span, .eval-head span, .knowledge-eval span { color: var(--ops-green); font: 8px ui-monospace, monospace; }.ops-band h2 { margin-top: 5px; font-size: 15px; }.ops-band > header > small { color: #707b82; font-size: 9px; }
...
.split-grid { display: grid; grid-template-columns: minmax(0, 1fr) 300px; }.data-table { min-width: 0; }.table-head, .table-row { min-height: 54px; padding: 0 16px; display: grid; grid-template-columns: 70px 135px 110px minmax(120px, 1fr) 205px; align-items: center; gap: 9px; border-bottom: 1px solid #22292e; }.table-head { min-height: 38px; color: #59646b; font: 8px ui-monospace, monospace; }.table-row { color: #aab4ae; font-size: 9px; }.table-row > strong { color: #edf4ef; font-size: 11px; }.status-dot { display: flex; align-items: center; gap: 6px; }.status-dot i, .endpoint-list article > i { width: 7px; height: 7px; border-radius: 50%; background: #68737a; }.status-dot.published i, .status-dot.canary i, .endpoint-list article > i.healthy { background: var(--ops-green); }.status-dot b { color: #81d7aa; font-size: 7px; }.row-actions button { min-height: 28px; padding: 0 7px; border: 1px solid #323a40; border-radius: 4px; background: #14191d; color: #9ba6ad; font: inherit; font-size: 8px; cursor: pointer; }
.diff-panel, .span-view { min-height: 300px; padding: 18px; border-left: 1px solid var(--ops-line); background: #11161a; }.diff-panel > span { color: #69747b; font: 8px ui-monospace, monospace; }.diff-panel > .el-icon, .span-view > .el-icon { display: block; margin: 72px auto 12px; color: #4d5a62; font-size: 28px; }.diff-panel > strong, .span-view > strong { display: block; text-align: center; font-size: 11px; }.diff-panel > p, .span-view > p { margin: 8px auto; max-width: 230px; color: #667179; font-size: 8px; line-height: 1.6; text-align: center; }.diff-panel ul { margin: 14px 0 0; padding: 0; list-style: none; }.diff-panel li { padding: 10px 0; display: grid; gap: 4px; border-top: 1px solid #273036; }.diff-panel li b { font-size: 9px; }.diff-panel li small { color: #9f6f6f; text-decoration: line-through; }.diff-panel li em { color: #7bc59e; font-style: normal; }
.eval-head { min-height: 68px; padding: 0 18px; display: flex; align-items: center; justify-content: space-between; border-top: 1px solid var(--ops-line); border-bottom: 1px solid var(--ops-line); }.eval-head h3, .knowledge-eval h3 { margin-top: 4px; font-size: 12px; }.dataset-grid { padding: 12px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.dataset-grid article { min-height: 112px; padding: 14px; position: relative; border: 1px solid #293138; background: #11161a; }.dataset-grid article > span { color: #6ab68c; font: 7px ui-monospace, monospace; text-transform: uppercase; }.dataset-grid article strong { display: block; margin-top: 10px; font-size: 10px; }.dataset-grid article p { margin-top: 5px; color: #69747b; font-size: 8px; }.dataset-grid article button { position: absolute; right: 12px; bottom: 12px; display: flex; gap: 4px; border: 0; background: transparent; color: #88d7aa; font: inherit; font-size: 8px; cursor: pointer; }
.trace-layout { display: grid; grid-template-columns: minmax(0, 1fr) 360px; }.trace-list { min-height: 480px; }.trace-list > button { width: 100%; min-height: 66px; padding: 0 16px; display: grid; grid-template-columns: 8px minmax(0, 1fr) 80px 65px; align-items: center; gap: 12px; border: 0; border-bottom: 1px solid #22292e; background: transparent; color: #abb5af; font: inherit; text-align: left; cursor: pointer; }.trace-list > button.selected, .trace-list > button:hover { background: #151e19; }.trace-list > button > i { width: 7px; height: 7px; border-radius: 50%; background: #d46f67; }.trace-list > button > i.success { background: var(--ops-green); }.trace-list p { min-width: 0; display: flex; flex-direction: column; gap: 4px; }.trace-list p strong { color: #e4ebe6; font-size: 10px; }.trace-list p span { overflow: hidden; color: #5d6870; font: 7px ui-monospace, monospace; text-overflow: ellipsis; }.trace-list em { color: #7c878e; font-size: 8px; font-style: normal; }.trace-list b { color: #8f9ba2; font-size: 8px; }.span-view { min-height: 480px; }.trace-meta { padding-bottom: 14px; display: flex; flex-direction: column; gap: 5px; border-bottom: 1px solid #293138; }.trace-meta span { color: #5e6970; font: 7px ui-monospace, monospace; }.trace-meta strong { font-size: 12px; }.trace-meta small { color: #748087; font-size: 8px; line-height: 1.5; }.span-view ol { margin: 12px 0; padding: 0; list-style: none; }.span-view li { min-height: 56px; display: grid; grid-template-columns: 8px 1fr auto; gap: 10px; align-items: center; border-bottom: 1px solid #252d32; }.span-view li > i { width: 7px; height: 7px; border: 2px solid #75c99b; border-radius: 50%; }.span-view li p { display: flex; flex-direction: column; gap: 4px; }.span-view li strong { font-size: 9px; }.span-view li span, .span-view li em { color: #68747b; font-size: 7px; font-style: normal; }
.slo-grid { display: grid; grid-template-columns: repeat(4, 1fr); border-bottom: 1px solid var(--ops-line); }.slo-grid article { min-height: 90px; padding: 15px; border-right: 1px solid var(--ops-line); border-bottom: 1px solid var(--ops-line); background: #10161a; }.slo-grid article:nth-child(4n) { border-right: 0; }.slo-grid span { color: #687c78; font: 7px ui-monospace, monospace; }.slo-grid strong { display: block; margin-top: 14px; color: #e9f3ed; font-size: 18px; }.quality-columns { display: grid; grid-template-columns: 1fr 1fr; }.quality-columns > div { min-height: 280px; border-right: 1px solid var(--ops-line); }.quality-columns > div:last-child { border-right: 0; }.quality-columns h3 { min-height: 44px; padding: 0 16px; display: flex; align-items: center; border-bottom: 1px solid #252d32; color: #8c9991; font-size: 10px; }.quality-columns article { min-height: 58px; padding: 0 16px; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #22292e; }.quality-columns article p { display: flex; flex-direction: column; gap: 5px; }.quality-columns article strong { color: #dfe9e2; font-size: 9px; }.quality-columns article small { color: #65717a; font-size: 7px; }.quality-columns article b { color: var(--ops-green); font-size: 10px; }.anomaly-strip { min-height: 46px; padding: 0 16px; display: flex; align-items: center; gap: 10px; border-top: 1px solid var(--ops-line); color: #718079; font-size: 8px; }.anomaly-strip b { padding: 5px 7px; border-radius: 4px; background: #322b1d; color: #edbb67; font: 7px ui-monospace, monospace; }.anomaly-strip b.critical { background: #372322; color: #eb8177; }.anomaly-strip small { color: #65716f; }.replay-output { max-height: 240px; margin: 0; padding: 14px 18px; overflow: auto; border-top: 1px solid var(--ops-line); background: #0a0e10; color: #92c9a8; font: 8px ui-monospace, monospace; white-space: pre-wrap; }
.route-decision { margin: 14px; min-height: 76px; padding: 14px; display: grid; grid-template-columns: 38px 1fr auto; gap: 12px; align-items: center; border: 1px solid #315441; background: #132119; }.route-decision > .el-icon { color: var(--ops-green); font-size: 22px; }.route-decision p { display: flex; flex-direction: column; gap: 4px; }.route-decision span { color: #698177; font-size: 8px; }.route-decision strong { font-size: 12px; }.route-decision small { color: #7f8d86; font-size: 8px; }.route-decision > b { color: var(--ops-green); font-size: 18px; }.endpoint-list article, .source-list article { min-height: 72px; padding: 0 18px; display: grid; grid-template-columns: 9px 1fr auto; gap: 13px; align-items: center; border-bottom: 1px solid #22292e; }.endpoint-list article > i.degraded { background: #e6b35f; }.endpoint-list article > i.unhealthy { background: #dd7169; }.endpoint-list p, .source-list p { display: flex; flex-direction: column; gap: 4px; }.endpoint-list p span, .source-list p span { color: #62bd8d; font: 7px ui-monospace, monospace; }.endpoint-list p strong, .source-list p strong { font-size: 10px; }.endpoint-list p small, .source-list p small { color: #68737a; font-size: 8px; }.endpoint-list article > div { display: flex; align-items: center; gap: 6px; }.endpoint-list em { min-width: 50px; color: #7c878e; font: 7px ui-monospace, monospace; font-style: normal; text-align: center; }.endpoint-list em.open { color: #e88075; }.endpoint-list button { width: 30px; height: 30px; display: grid; place-items: center; border: 1px solid #30383e; border-radius: 4px; background: #151a1e; color: #879198; cursor: pointer; }.endpoint-list button:disabled { opacity: .3; }
.source-list article { grid-template-columns: 30px 1fr auto; }.source-list article > .el-icon { color: #79c99e; font-size: 18px; }.source-list article > b { color: #7c878e; font-size: 8px; }.knowledge-eval { margin: 16px; padding: 16px; display: grid; grid-template-columns: minmax(170px, 1fr) minmax(180px, 2fr) 170px auto auto; gap: 10px; align-items: center; border: 1px solid #2a343a; background: #12171a; }.knowledge-eval input { min-height: 36px; padding: 0 10px; border: 1px solid #323b41; border-radius: 5px; outline: 0; background: #0d1114; color: #dce5df; font: inherit; font-size: 9px; }.knowledge-eval > small { color: #7dc79f; font-size: 8px; }
.workflow-columns { display: grid; grid-template-columns: 1fr 1fr; }.workflow-columns > div { min-height: 460px; border-right: 1px solid var(--ops-line); }.workflow-columns > div:last-child { border: 0; }.workflow-columns h3 { min-height: 45px; padding: 0 16px; display: flex; align-items: center; border-bottom: 1px solid #252d32; color: #78838a; font-size: 9px; }.workflow-columns article { min-height: 76px; padding: 0 16px; display: grid; grid-template-columns: 34px 1fr auto; gap: 11px; align-items: center; border-bottom: 1px solid #22292e; }.workflow-columns article > .el-icon { color: #76c99c; font-size: 18px; }.workflow-columns article p { display: flex; flex-direction: column; gap: 4px; }.workflow-columns article span { color: #65b989; font: 7px ui-monospace, monospace; }.workflow-columns article strong { font-size: 10px; }.workflow-columns article small { color: #68737a; font-size: 8px; }.workflow-columns article button { min-height: 30px; border: 1px solid #354039; border-radius: 4px; background: #152019; color: #81d5a6; font: inherit; font-size: 8px; }.workflow-columns article > b { color: #79ce9f; font-size: 8px; }
.diagnostic-state { display: flex; align-items: center; gap: 7px; color: #d47c70; font: 8px ui-monospace, monospace; text-transform: uppercase; }.diagnostic-state i { width: 8px; height: 8px; border-radius: 50%; background: currentColor; }.diagnostic-state.ready { color: var(--ops-green); }.diagnostic-summary { display: grid; grid-template-columns: 130px 130px 130px 1fr; border-bottom: 1px solid var(--ops-line); }.diagnostic-summary > div { min-height: 92px; padding: 16px; display: flex; flex-direction: column; border-right: 1px solid var(--ops-line); }.diagnostic-summary strong { margin-top: auto; font-size: 22px; }.diagnostic-summary span { color: #68737a; font: 7px ui-monospace, monospace; }.diagnostic-summary p { padding: 16px; display: flex; align-items: center; gap: 10px; color: #7a858c; font-size: 9px; }.check-list article { min-height: 72px; padding: 0 18px; display: grid; grid-template-columns: 34px minmax(180px, 1fr) minmax(220px, 1fr) 70px; gap: 12px; align-items: center; border-bottom: 1px solid #22292e; }.check-status { width: 30px; height: 30px; display: grid; place-items: center; border-radius: 5px; background: #382322; color: #df776e; }.check-status.pass { background: #15291f; color: var(--ops-green); }.check-status.warning { background: #332c1d; color: #edbc65; }.check-list p { display: flex; flex-direction: column; gap: 5px; }.check-list strong { font-size: 10px; }.check-list small, .check-list em { color: #6f7a81; font-size: 8px; font-style: normal; line-height: 1.5; }.check-list b { color: #89949a; font: 7px ui-monospace, monospace; text-transform: uppercase; }
.empty-row { min-height: 100px; padding: 22px; display: grid; place-items: center; color: #626d74; font-size: 9px; text-align: center; }.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
