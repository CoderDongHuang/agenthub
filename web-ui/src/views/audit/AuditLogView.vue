...
.audit-summary > div > span { color: #858b82; font-family: ui-monospace, monospace; font-size: 12px; }
.audit-summary > div > strong { margin-top: auto; font-size: 22px; }
.audit-summary > div > small { margin-top: 4px; color: #8c9289; font-size: 12px; }
...
.audit-ledger time span { color: #8d938a; font-size: 12px; }
...
.entry-head > span { color: var(--console-orange); font-family: ui-monospace, monospace; font-size: 12px; }
.entry-head > b { display: flex; align-items: center; gap: 5px; color: #7c8279; font-family: ui-monospace, monospace; font-size: 12px; }
...
.ledger-entry > p { margin-top: 7px; color: var(--console-muted); font-size: 12px; line-height: 1.6; }
...
.entry-meta b { display: block; margin-top: 4px; color: var(--console-ink); font-size: 12px; }
...
.audit-empty strong { margin-top: 13px; color: var(--console-ink); font-size: 12px; }
.audit-empty span { margin-top: 6px; font-size: 12px; }
