...
.analytics-overview span { color: var(--console-muted); font-size: 9px; }.analytics-overview strong { margin-top: auto; font-size: 23px; }.analytics-overview strong small { color: #8b958f; font-size: 11px; font-weight: 500; }.analytics-overview > div > small { margin-top: 6px; color: #89938d; font-size: 8px; }
...
.panel-heading { display: flex; align-items: start; justify-content: space-between; }.panel-heading span { color: var(--console-primary); font-size: 9px; font-weight: 700; }.panel-heading h2 { margin-top: 5px; font-size: 15px; }.panel-heading > b { display: flex; align-items: center; gap: 6px; color: var(--console-primary-dark); font-size: 9px; }.panel-heading > small { color: var(--console-muted); font-size: 8px; }
.usage-chart { height: 240px; margin-top: 20px; padding-top: 16px; display: grid; grid-template-columns: repeat(7, 1fr); gap: 10px; border-top: 1px solid var(--console-line); }.chart-day { display: grid; grid-template-rows: 20px 1fr 20px; justify-items: center; }.chart-day > span, .chart-day small { color: #87918b; font-size: 8px; }.chart-day > div { width: 100%; height: 170px; display: flex; align-items: flex-end; border-radius: 5px 5px 0 0; background: #f0f4f0; overflow: hidden; }.chart-day i { width: 100%; display: block; border-radius: 5px 5px 0 0; background: var(--console-primary); }.chart-legend { padding-top: 13px; display: flex; justify-content: space-between; border-top: 1px solid var(--console-line); color: #8b958f; font-size: 8px; }.chart-legend span:first-child { display: flex; align-items: center; gap: 6px; }.chart-legend i { width: 8px; height: 8px; border-radius: 2px; background: var(--console-primary); }
.saving-panel { background: var(--console-blue-soft); border-color: #d7e2e8; }.saving-panel > span { color: #607d91; font-size: 9px; font-weight: 700; }.saving-panel h2 { margin-top: 10px; font-size: 18px; line-height: 1.4; }.saving-item { margin-top: 22px; display: grid; grid-template-columns: 26px 1fr; gap: 9px; }.saving-item > b { width: 26px; height: 26px; display: grid; place-items: center; border-radius: 6px; background: white; color: #607d91; font-size: 8px; }.saving-item p { display: flex; flex-direction: column; gap: 5px; }.saving-item strong { font-size: 10px; }.saving-item span { color: #657e8f; font-size: 8px; line-height: 1.4; }.saving-panel > button { width: 100%; min-height: 40px; margin-top: 25px; border: 0; border-radius: 7px; background: #5e7b90; color: white; font: inherit; font-size: 10px; font-weight: 700; cursor: pointer; }
.model-cost-panel { min-width: 0; }.cost-table { margin-top: 18px; border: 1px solid var(--console-line); border-radius: 7px; overflow: hidden; }.cost-head, .cost-row { min-height: 48px; padding: 0 14px; display: grid; grid-template-columns: 1.4fr repeat(4, .65fr); gap: 8px; align-items: center; }.cost-head { min-height: 40px; background: #f5f7f4; color: var(--console-muted); font-size: 8px; }.cost-row { border-top: 1px solid var(--console-line); }.cost-row strong { font-size: 10px; }.cost-row span { color: #6f7c75; font-size: 9px; }.cost-row b { color: var(--console-coral); font-size: 9px; }.cost-row b.down { color: var(--console-green); }
.cost-empty { padding: 30px 14px; color: var(--console-muted); font-size: 9px; text-align: center; }
.anomaly-panel .panel-heading > .el-icon { color: var(--console-yellow); font-size: 20px; }.anomaly-panel article { margin-top: 18px; padding: 14px; border-radius: 7px; background: #f8efe2; color: #755f3c; }.anomaly-panel article > span { font-size: 8px; font-weight: 700; }.anomaly-panel article strong { display: block; margin-top: 7px; font-size: 11px; }.anomaly-panel article p { margin-top: 6px; font-size: 8px; line-height: 1.55; }.anomaly-panel article small { display: block; margin-top: 12px; color: #9b845d; font-size: 7px; }.anomaly-panel article.quiet { background: var(--console-primary-soft); color: var(--console-primary-dark); }
