...
.lab-header { min-height: 64px; padding: 0 16px; display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; border-bottom: 1px solid var(--console-line); background: #111518; }.back-button { justify-self: start; padding: 0; display: inline-flex; align-items: center; gap: 7px; border: 0; background: transparent; color: #8c969d; font: inherit; font-size: 9px; font-weight: 700; cursor: pointer; }.back-button:hover { color: var(--console-ink); }.lab-agent { text-align: center; }.lab-agent span { color: var(--console-accent); font: 7px ui-monospace, monospace; }.lab-agent h1 { margin: 4px 0 0; color: #edf3ef; font-size: 14px; }.lab-status { justify-self: end; display: flex; align-items: center; gap: 9px; }.lab-status > span { display: flex; align-items: center; gap: 5px; color: #727c83; font: 7px ui-monospace, monospace; text-transform: uppercase; }.lab-status > span i { width: 6px; height: 6px; border-radius: 50%; background: var(--console-warning); }.lab-status > span i.published { background: var(--console-accent); box-shadow: 0 0 7px rgba(82,231,160,.55); }.lab-status > b { max-width: 140px; overflow: hidden; color: #7b858c; font-size: 8px; text-overflow: ellipsis; white-space: nowrap; }.lab-status button { min-height: 30px; padding: 0 10px; border: 1px solid #353c42; border-radius: 5px; background: #171c20; color: #b7c0ba; font: inherit; font-size: 8px; cursor: pointer; }
.lab-workspace { min-height: 0; flex: 1; display: grid; grid-template-columns: 218px minmax(360px, 1fr) 330px; }.request-panel { min-width: 0; display: flex; flex-direction: column; border-right: 1px solid var(--console-line); background: #0d1113; }.request-head { min-height: 70px; padding: 15px; display: grid; grid-template-columns: 1fr auto; align-content: center; border-bottom: 1px solid var(--console-line); }.request-head span { grid-column: 1 / -1; color: #59636a; font: 7px ui-monospace, monospace; }.request-head strong { margin-top: 5px; color: #dbe3de; font-size: 11px; }.request-head small { margin-top: 5px; color: #6f7980; font-size: 8px; }.new-request { min-height: 38px; margin: 10px; display: flex; align-items: center; gap: 8px; border: 1px dashed #363e43; border-radius: 6px; background: transparent; color: #8e989f; font: inherit; font-size: 9px; cursor: pointer; }.new-request span { width: 28px; font-size: 15px; }.new-request:hover { border-color: #48735d; color: #85dfac; }.request-list { min-height: 0; flex: 1; padding: 0 8px; overflow-y: auto; }.request-list > button { width: 100%; min-height: 64px; padding: 9px; display: grid; grid-template-columns: 26px 1fr 6px; gap: 8px; align-items: center; border: 0; border-bottom: 1px solid #242a2e; background: transparent; color: #cbd4ce; font: inherit; text-align: left; cursor: pointer; }.request-list > button:hover { border-radius: 6px; background: #151b18; }.request-list > button > span { color: #596269; font: 7px ui-monospace, monospace; }.request-list p { min-width: 0; display: flex; flex-direction: column; gap: 5px; }.request-list strong { overflow: hidden; font-size: 9px; text-overflow: ellipsis; white-space: nowrap; }.request-list small { color: #606a71; font-size: 7px; }.request-list i { width: 5px; height: 5px; border-radius: 50%; background: var(--console-accent); }.request-empty { min-height: 200px; display: flex; flex-direction: column; align-items: center; justify-content: center; color: #4f585e; text-align: center; }.request-empty .el-icon { font-size: 20px; }.request-empty strong { margin-top: 10px; color: #879198; font-size: 9px; }.request-empty span { max-width: 140px; margin-top: 6px; font-size: 8px; line-height: 1.5; }.request-config { margin: 10px; padding: 12px; border: 1px solid #262c31; border-radius: 6px; background: #111518; }.request-config > span { color: #69737a; font-size: 8px; }.request-config dl { margin: 9px 0 0; }.request-config dl div { min-height: 25px; display: grid; grid-template-columns: 52px 1fr; align-items: center; }.request-config dt { color: #596269; font-size: 7px; }.request-config dd { margin: 0; overflow: hidden; color: #a1aca5; font: 7px ui-monospace, monospace; text-align: right; text-overflow: ellipsis; white-space: nowrap; }
.conversation-panel { min-width: 0; display: flex; flex-direction: column; background: #111518; }.conversation-toolbar { min-height: 40px; padding: 0 14px; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid var(--console-line); }.conversation-toolbar > div, .conversation-toolbar p { display: flex; align-items: center; gap: 6px; }.conversation-toolbar i { width: 6px; height: 6px; border-radius: 50%; background: #626b71; }.conversation-toolbar i.active { background: var(--console-accent); }.conversation-toolbar i.running { background: var(--console-warning); animation: pulse 1.4s infinite; }.conversation-toolbar span { color: #667077; font: 7px ui-monospace, monospace; }.conversation-toolbar b { color: #9aa59e; font: 7px ui-monospace, monospace; }.conversation-stream { flex: 1; min-height: 0; padding: 20px; overflow-y: auto; background: #0f1315; }.system-event { min-height: 42px; padding: 9px 11px; display: grid; grid-template-columns: 58px 1fr auto; align-items: center; border: 1px solid #273028; border-radius: 6px; background: #131a16; }.system-event span { color: #68d89d; font: 7px ui-monospace, monospace; }.system-event p { color: #8d9891; font-size: 9px; }.system-event time, .inline-tool time { color: #596269; font-size: 7px; }.message-row { max-width: 82%; margin-top: 19px; }.message-row.user { margin-left: auto; }.message-meta { margin-bottom: 6px; display: flex; justify-content: space-between; color: #626b72; font: 7px ui-monospace, monospace; }.message-body { padding: 14px 16px; border: 1px solid #30373c; border-radius: 7px; background: #171c20; color: #cbd4ce; font-size: 11px; line-height: 1.72; white-space: pre-wrap; }.message-row.user .message-body { border-color: #345b47; background: #183026; color: #d8eee1; }.message-row.user .message-meta span { color: var(--console-accent); }.markdown-message { white-space: normal; }.markdown-message :deep(p) { margin: 0; }.markdown-message :deep(p + p), .markdown-message :deep(ul), .markdown-message :deep(ol), .markdown-message :deep(pre) { margin-top: 11px; }.markdown-message :deep(ul), .markdown-message :deep(ol) { padding-left: 18px; }.markdown-message :deep(code) { padding: 2px 5px; border-radius: 3px; background: #0d1113; color: #e8bd73; font: .92em ui-monospace, monospace; }.markdown-message :deep(pre) { padding: 12px; overflow-x: auto; background: #0b0e10; color: #bdc7c0; }.inline-tool { min-height: 42px; max-width: 88%; margin: 12px auto 0; padding: 8px 10px; display: grid; grid-template-columns: 24px 70px 1fr auto; align-items: center; border: 1px solid #343320; border-radius: 6px; background: #1b1912; }.inline-tool .el-icon { color: var(--console-warning); }.inline-tool.end { border-color: #263b30; background: #131c17; }.inline-tool.end .el-icon { color: var(--console-accent); }.inline-tool span { color: #7b7567; font: 7px ui-monospace, monospace; }.inline-tool strong { overflow: hidden; color: #b7b09f; font-size: 8px; text-overflow: ellipsis; white-space: nowrap; }.inline-error { margin-top: 12px; padding: 11px; border: 1px solid #512e2d; border-left: 3px solid var(--console-danger); border-radius: 5px; background: #231414; color: #e98a83; font-size: 9px; }.inline-error span { font: 7px ui-monospace, monospace; }.inline-error p { margin: 5px 0 0; }.composer { padding: 12px 14px; border-top: 1px solid var(--console-line); background: #111518; }.composer-meta { margin-bottom: 7px; display: flex; justify-content: space-between; color: #5b646b; font: 7px ui-monospace, monospace; }.composer-box { min-height: 74px; display: grid; grid-template-columns: 1fr 70px; border: 1px solid #343c42; border-radius: 7px; background: #0e1214; overflow: hidden; }.composer-box:focus-within { border-color: #4a8b68; box-shadow: 0 0 0 3px rgba(82,226,157,.06); }.composer textarea { min-height: 72px; padding: 13px; resize: none; border: 0; outline: 0; background: transparent; color: var(--console-ink); font: inherit; font-size: 10px; line-height: 1.6; }.composer button { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 5px; border: 0; background: #4ee09a; color: #06110b; font: inherit; font-size: 8px; font-weight: 800; cursor: pointer; }.composer button:disabled { background: #26322c; color: #657069; cursor: not-allowed; }
.trace-panel { min-height: 0; padding: 16px; overflow-y: auto; border-left: 1px solid var(--console-line); background: #0b0e10; color: var(--console-ink); }.trace-head { display: grid; grid-template-columns: 28px 1fr; }.trace-head .el-icon { grid-row: 1 / 3; align-self: center; color: var(--console-accent); font-size: 18px; }.trace-head span { color: #5f696f; font: 7px ui-monospace, monospace; }.trace-head strong { margin-top: 4px; font-size: 12px; }.trace-stats { margin-top: 16px; display: grid; grid-template-columns: .6fr .6fr 1fr; border: 1px solid #292f34; border-radius: 6px; overflow: hidden; }.trace-stats div { min-width: 0; min-height: 54px; padding: 9px; display: flex; flex-direction: column; justify-content: flex-end; border-right: 1px solid #292f34; }.trace-stats div:last-child { border-right: 0; }.trace-stats span { color: #535c62; font: 6px ui-monospace, monospace; }.trace-stats strong { margin-top: 5px; overflow: hidden; font-size: 8px; text-overflow: ellipsis; white-space: nowrap; }.trace-list { position: relative; margin-top: 15px; padding-left: 1px; }.trace-list::before { content: ''; position: absolute; top: 8px; bottom: 8px; left: 4px; width: 1px; background: #2d3438; }.trace-list > div, .trace-list > article { position: relative; min-height: 56px; padding: 9px 0 9px 20px; display: grid; grid-template-columns: 1fr; border-top: 1px solid #242a2e; }.trace-list i { position: absolute; z-index: 1; left: 0; top: 13px; width: 9px; height: 9px; border: 2px solid #0b0e10; border-radius: 50%; background: #555e64; }.trace-list i.done, .trace-list i.tool_end { background: var(--console-accent); box-shadow: 0 0 8px rgba(82,232,160,.35); }.trace-list i.tool_start, .trace-running i { background: var(--console-warning); }.trace-list i.error { background: var(--console-danger); }.trace-list i.approval { background: var(--console-warning); box-shadow: 0 0 0 4px rgba(231,184,93,.12), 0 0 13px rgba(231,184,93,.35); animation: pulse 1.5s infinite; }.trace-list span { color: #596269; font: 6px ui-monospace, monospace; }.trace-list strong { margin-top: 4px; overflow: hidden; color: #aab4ad; font-size: 8px; text-overflow: ellipsis; white-space: nowrap; }.trace-list small { margin-top: 4px; color: #525b61; font-size: 7px; }.trace-list .idle i { background: #434c51; }.approval-trace { padding-bottom: 13px !important; }.approval-card { margin-top: 10px; padding: 11px; border: 1px solid #5a4320; border-radius: 7px; background: #21190d; box-shadow: 0 0 22px rgba(224,171,72,.08); }.approval-card header { display: flex; gap: 8px; color: #eab75a; }.approval-card header .el-icon { position: static; width: auto; height: auto; border: 0; border-radius: 0; background: transparent; }.approval-card header p { display: flex; flex-direction: column; gap: 4px; }.approval-card b { font-size: 9px; }.approval-card em { color: #ad9262; font-size: 7px; font-style: normal; line-height: 1.4; }.approval-card pre { max-height: 74px; margin: 10px 0 0; padding: 8px; overflow: auto; border: 1px solid #3e321f; border-radius: 4px; background: #141009; color: #9c8d72; font: 7px/1.5 ui-monospace, monospace; white-space: pre-wrap; }.approval-card footer { margin-top: 9px; display: grid; grid-template-columns: .8fr 1.2fr; gap: 6px; }.approval-card button { min-height: 30px; display: flex; align-items: center; justify-content: center; gap: 5px; border: 1px solid #57462d; border-radius: 5px; background: transparent; color: #c5ad83; font: inherit; font-size: 7px; cursor: pointer; }.approval-card button:last-child { border-color: #d5a84e; background: #dbad50; color: #1c1407; font-weight: 800; }.trace-foot { min-height: 38px; margin-top: 14px; display: flex; align-items: center; gap: 7px; border-top: 1px solid #282e32; color: #596269; font-size: 7px; }
...
.approval-card .json-toggle { width: 100%; min-height: 28px; margin-top: 6px; border: 1px solid #4d4029; border-radius: 4px; background: rgba(245,158,11,.08); color: #f4c873; font: inherit; font-size: 7px; cursor: pointer; }
</style>
