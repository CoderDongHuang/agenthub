...
<style scoped>
.model-hero { min-height: 590px; padding: 92px max(30px, calc((100vw - 1240px) / 2)); display: grid; grid-template-columns: 1.12fr .88fr; gap: 90px; align-items: center; background: #edf2f5; }.model-hero h1 { max-width: 760px; margin-top: 20px; font-size: 58px; line-height: 1.08; }.model-hero > div:first-child > p { max-width: 700px; margin-top: 24px; color: #687984; font-size: 16px; line-height: 1.8; }.model-selector { padding: 24px; border: 1px solid #cad8e0; border-radius: 8px; background: rgba(255,255,255,.72); box-shadow: 16px 16px 0 #dce6eb; }.model-selector > span { color: var(--site-blue); font-size: 10px; font-weight: 700; }.selector-modes { margin-top: 16px; padding: 3px; display: grid; grid-template-columns: repeat(3, 1fr); border: 1px solid var(--site-line); border-radius: 7px; background: #eef3f5; }.selector-modes button { min-height: 36px; border: 0; border-radius: 5px; background: transparent; color: #71838e; font: inherit; font-size: 9px; cursor: pointer; }.selector-modes button.active { background: white; color: #4d6e83; box-shadow: 0 2px 7px rgba(69,92,106,.08); }.recommendation { margin-top: 18px; padding: 20px; border-radius: 7px; background: #54748a; color: white; }.recommendation small { color: #cddbe3; font-size: 9px; }.recommendation > strong { display: block; margin-top: 10px; font-size: 22px; }.recommendation > p { margin-top: 8px; color: #d8e3e9; font-size: 10px; line-height: 1.6; }.recommendation > div { margin-top: 20px; padding-top: 14px; display: flex; justify-content: space-between; border-top: 1px solid rgba(255,255,255,.2); color: #c9d8e0; font-size: 8px; }.recommendation b { display: block; margin-top: 4px; color: white; }
.model-principles { padding: 0 max(30px, calc((100vw - 1240px) / 2)); display: grid; grid-template-columns: repeat(4, 1fr); background: white; }.model-principles > div { min-height: 190px; padding: 28px 24px; display: flex; flex-direction: column; border-right: 1px solid var(--site-line); }.model-principles > div:first-child { border-left: 1px solid var(--site-line); }.model-principles span { color: var(--site-blue); font-size: 9px; font-weight: 700; }.model-principles strong { margin-top: 38px; font-size: 15px; }.model-principles p { margin-top: 9px; color: var(--site-muted); font-size: 10px; line-height: 1.65; }
.provider-section { padding: 100px max(30px, calc((100vw - 1240px) / 2)); background: var(--site-paper); }.provider-heading { display: flex; align-items: end; justify-content: space-between; gap: 30px; }.provider-heading h2 { margin-top: 14px; font-size: 39px; }.provider-tools { display: flex; gap: 10px; }.region-filter, .provider-tools label { min-height: 42px; display: flex; align-items: center; border: 1px solid var(--site-line); border-radius: 7px; background: white; overflow: hidden; }.region-filter > .el-icon { margin-left: 12px; color: #8a958f; }.region-filter button { align-self: stretch; padding: 0 11px; border: 0; background: transparent; color: var(--site-muted); font: inherit; font-size: 10px; cursor: pointer; }.region-filter button.active { background: var(--site-blue-soft); color: #527289; }.provider-tools label { width: 220px; padding: 0 11px; gap: 7px; }.provider-tools input { min-width: 0; width: 100%; border: 0; outline: 0; font: inherit; font-size: 10px; }.provider-grid { margin-top: 28px; display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; }.provider-grid article { min-height: 250px; padding: 22px; display: flex; flex-direction: column; border: 1px solid var(--site-line); border-radius: 8px; background: white; }.provider-top { display: grid; grid-template-columns: 42px 1fr auto; gap: 11px; align-items: center; }.provider-top > span { width: 42px; height: 42px; display: grid; place-items: center; border-radius: 8px; color: white; font-size: 10px; font-weight: 800; }.provider-top p { display: flex; flex-direction: column; gap: 4px; }.provider-top strong { font-size: 13px; }.provider-top small { color: var(--site-muted); font-size: 8px; }.provider-top > b { display: flex; align-items: center; gap: 5px; color: #8b958f; font-size: 8px; }.provider-top > b i { width: 7px; height: 7px; border-radius: 50%; background: var(--site-amber); }.provider-top > b.ready i { background: var(--site-primary); }.provider-models { margin-top: 22px; display: flex; flex-wrap: wrap; gap: 7px; }.provider-models span { padding: 7px 9px; border-radius: 5px; background: #f2f5f2; color: var(--site-ink-soft); font-size: 9px; }.provider-abilities { margin-top: 14px; display: flex; gap: 15px; }.provider-abilities span { display: flex; align-items: center; gap: 5px; color: var(--site-muted); font-size: 9px; }.provider-abilities .el-icon { color: var(--site-primary); }.provider-foot { margin-top: auto; padding-top: 15px; display: flex; justify-content: space-between; border-top: 1px solid var(--site-line); color: #87928c; font-size: 8px; }.provider-foot a { display: flex; align-items: center; gap: 5px; color: #55778c; text-decoration: none; font-weight: 700; }.empty-models { grid-column: 1 / -1; padding: 60px; text-align: center; color: var(--site-muted); }.route-policy { padding: 96px max(30px, calc((100vw - 1240px) / 2)); display: grid; grid-template-columns: .65fr 1.35fr; gap: 80px; background: #f3eee5; }.policy-copy h2 { margin-top: 18px; font-size: 39px; line-height: 1.16; }.policy-copy p { margin-top: 16px; color: var(--site-muted); font-size: 13px; line-height: 1.7; }.policy-board { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }.policy-board > div { min-height: 170px; padding: 20px; display: flex; flex-direction: column; border: 1px solid #ddd6ca; border-radius: 8px; background: rgba(255,255,255,.72); }.policy-board span { color: #8b958f; font-size: 9px; }.policy-board strong { margin-top: 18px; font-size: 16px; }.policy-board small { margin-top: 7px; color: var(--site-muted); font-size: 9px; }.policy-board b { margin-top: auto; color: var(--site-coral); font-size: 11px; }
