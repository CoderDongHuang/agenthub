...
.preference-head h2 { margin-top: 5px; font-size: 22px; }.preference-head p { margin-top: 6px; color: var(--cyber-muted); font-size: 12px; }
...
.preference-field { margin-top: 18px; }.preference-field > label, .range-field label { margin-bottom: 8px; display: flex; justify-content: space-between; color: var(--cyber-text-soft); font-size: 12px; font-weight: 700; }
.preference-segment { padding: 3px; display: grid; grid-template-columns: repeat(2, 1fr); gap: 3px; border: 1px solid var(--cyber-line); border-radius: 7px; background: var(--cyber-bg-deep); }.preference-segment button { min-height: 35px; border: 0; border-radius: 5px; background: transparent; color: var(--cyber-muted); font: inherit; font-size: 12px; cursor: pointer; }.preference-segment button.active { background: var(--cyber-indigo-soft); color: #c7d2fe; box-shadow: inset 0 0 0 1px rgba(99,102,241,.28); }
.theme-options { display: grid; grid-template-columns: repeat(3,1fr); gap: 8px; }.theme-options button { min-width: 0; padding: 7px; display: flex; flex-direction: column; gap: 7px; border: 1px solid var(--cyber-line); border-radius: 7px; background: transparent; color: var(--cyber-muted); font: inherit; font-size: 12px; cursor: pointer; }.theme-options button.active { border-color: rgba(99,102,241,.6); color: var(--cyber-text); box-shadow: 0 0 0 2px rgba(99,102,241,.1); }.theme-preview { height: 52px; display: grid; place-items: center; border-radius: 5px; font-size: 17px; }.theme-preview svg { width: 18px; }.theme-preview.dark { background: #0b0f17; color: #a5b4fc; }.theme-preview.light { background: #f5f7fb; color: #4f46e5; }.theme-preview.custom { background: linear-gradient(135deg,#16213a,#344267); color: #dbeafe; }
.custom-theme-controls { margin-top: 12px; padding: 12px; border: 1px solid var(--cyber-line); border-radius: 7px; background: var(--cyber-panel); }.background-upload { display: flex; gap: 7px; }.background-upload label { min-height: 38px; padding: 0 11px; flex: 1; display: flex; align-items: center; gap: 7px; border: 1px dashed var(--cyber-line-strong); border-radius: 6px; color: var(--cyber-text-soft); font-size: 12px; cursor: pointer; }.background-upload input { display: none; }.background-upload button { width: 38px; border: 1px solid var(--cyber-line); border-radius: 6px; background: transparent; color: var(--cyber-red); cursor: pointer; }.custom-theme-controls > small { margin-top: 7px; display: block; color: var(--cyber-muted); font-size: 12px; }.custom-theme-controls > small.error { color: #fda4af; }
.range-field { margin-top: 15px; }.range-field b { color: #c7d2fe; font-size: 12px; }.range-field input { width: 100%; accent-color: var(--cyber-indigo); }
.preference-field select { width: 100%; min-height: 40px; padding: 0 10px; border: 1px solid var(--cyber-line-strong); border-radius: 7px; outline: 0; background: var(--cyber-bg-deep); color: var(--cyber-text-soft); font: inherit; font-size: 12px; }
.preference-toggle { position: relative; min-height: 48px; margin-top: 14px; padding: 0 50px 0 0; display: flex; align-items: center; cursor: pointer; }.preference-toggle span { display: flex; flex-direction: column; gap: 4px; }.preference-toggle b { color: var(--cyber-text-soft); font-size: 12px; }.preference-toggle small { color: var(--cyber-muted); font-size: 12px; line-height: 1.5; }.preference-toggle input { position: absolute; opacity: 0; }.preference-toggle > i { position: absolute; right: 0; width: 38px; height: 22px; border-radius: 11px; background: #283246; transition: background .18s; }.preference-toggle > i::after { content: ''; position: absolute; left: 3px; top: 3px; width: 16px; height: 16px; border-radius: 50%; background: #a8b3c4; transition: transform .18s, background .18s; }.preference-toggle input:checked + i { background: var(--cyber-indigo); }.preference-toggle input:checked + i::after { transform: translateX(16px); background: #fff; }.preference-toggle input:disabled + i { opacity: .45; }
.line-threshold { width: 120px; min-height: 34px; margin-left: auto; display: grid; grid-template-columns: 1fr auto; align-items: center; border: 1px solid var(--cyber-line); border-radius: 6px; overflow: hidden; }.line-threshold input { min-width: 0; height: 32px; padding: 0 8px; border: 0; outline: 0; background: var(--cyber-bg-deep); color: var(--cyber-text); }.line-threshold span { padding-right: 8px; color: var(--cyber-muted); font-size: 12px; }
.notification-permission { width: 100%; min-height: 38px; margin-top: 9px; display: flex; align-items: center; justify-content: center; gap: 7px; border: 1px solid rgba(99,102,241,.35); border-radius: 6px; background: var(--cyber-indigo-soft); color: #c7d2fe; font: inherit; font-size: 12px; cursor: pointer; }.permission-state { margin-top: 9px; display: flex; align-items: center; gap: 6px; color: #6ee7b7; font-size: 12px; }.permission-state i { width: 6px; height: 6px; border-radius: 50%; background: var(--cyber-green); }.permission-state.muted { color: var(--cyber-muted); }
.preference-foot { min-height: 68px; padding: 12px 22px; display: flex; align-items: center; justify-content: space-between; gap: 12px; border-top: 1px solid var(--cyber-line); background: var(--cyber-bg-deep); }.preference-foot > span { display: flex; align-items: center; gap: 6px; color: var(--cyber-muted); font-size: 12px; }.preference-foot > span i { width: 6px; height: 6px; border-radius: 50%; background: var(--cyber-green); }.preference-foot button { min-height: 36px; padding: 0 11px; display: flex; align-items: center; gap: 6px; border: 1px solid var(--cyber-line-strong); border-radius: 6px; background: var(--cyber-panel); color: var(--cyber-text-soft); font: inherit; font-size: 12px; cursor: pointer; }
