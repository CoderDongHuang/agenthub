...
const results = computed(() => {
  ...
  const home = locale.value === 'en-US'
    ? { label: 'AgentMesh Home', short: 'Home', path: '/', hint: 'Platform overview and live sandbox' }
    : { label: 'AgentMesh 首页', short: '首页', path: '/', hint: '平台能力总览与动态沙箱' }
  ...
  <header class="site-header">
    <div class="site-header__inner">
      <button class="site-brand" aria-label="返回首页" @click="navigate('/')">
        <img class="site-brand__logo" src="/bg.svg" alt="AgentMesh" />
        <span class="site-brand__name">AgentMesh</span>
      </button>
...
<style scoped>
.site-search-button { min-height: 34px; padding: 0 8px; display: inline-flex; align-items: center; gap: 6px; border: 1px solid #30373c; border-radius: 6px; background: #121619; color: #818b92; font: inherit; font-size: 12px; cursor: pointer; }.site-search-button:hover { border-color: #465058; color: #c9d2cc; }.site-search-button kbd, .site-search-dialog kbd { padding: 2px 5px; border: 1px solid #343c42; border-radius: 4px; background: #0c0f11; color: #697279; font: 12px ui-monospace, monospace; }
.site-search-backdrop { position: fixed; inset: 0; z-index: 200; padding-top: min(14vh, 110px); display: flex; align-items: flex-start; justify-content: center; background: rgba(0,0,0,.72); backdrop-filter: blur(5px); }.site-search-dialog { width: min(600px, calc(100% - 28px)); max-height: 70vh; display: flex; flex-direction: column; border: 1px solid #3b444a; border-radius: 8px; background: #101417; box-shadow: 0 32px 90px rgba(0,0,0,.62); overflow: hidden; }.site-search-dialog > header { min-height: 58px; padding: 0 10px 0 15px; display: flex; align-items: center; gap: 10px; border-bottom: 1px solid #293035; color: #5de49f; }.site-search-dialog input { min-width: 0; flex: 1; border: 0; outline: 0; background: transparent; color: #edf3ef; font: inherit; font-size: 12px; }.site-search-dialog input::placeholder { color: #5f686f; }.search-close { width: 36px; height: 36px; display: grid; place-items: center; border: 1px solid #343c42; border-radius: 6px; background: #14191d; color: #aab5bf; cursor: pointer; }.search-close:hover { border-color: #6366f1; color: #fff; }.search-summary { min-height: 38px; padding: 0 14px; display: flex; align-items: center; justify-content: space-between; color: #636d74; font: 12px ui-monospace, monospace; }.search-results { min-height: 0; padding: 0 7px 7px; overflow-y: auto; }.search-results button { width: 100%; min-height: 58px; padding: 8px 10px; display: grid; grid-template-columns: 36px 1fr 18px; gap: 10px; align-items: center; border: 0; border-radius: 6px; background: transparent; color: #d7dfda; font: inherit; text-align: left; cursor: pointer; }.search-results button:hover { background: #19231d; }.search-results button > span { width: 34px; height: 34px; display: grid; place-items: center; border: 1px solid #324139; border-radius: 6px; background: #16221b; color: #7ce6ad; font-size: 12px; font-weight: 800; }.search-results p { display: flex; flex-direction: column; gap: 4px; }.search-results strong { font-size: 12px; }.search-results small { color: #6d777e; font-size: 12px; }.search-results button > .el-icon { color: #515a61; }.search-empty { min-height: 180px; display: grid; place-items: center; color: #667078; font-size: 12px; }.site-search-dialog > footer { min-height: 40px; padding: 0 14px; display: flex; align-items: center; gap: 18px; border-top: 1px solid #293035; color: #606a71; font-size: 12px; }.site-search-dialog > footer span { display: flex; align-items: center; gap: 5px; }.mobile-search { align-items: center; justify-content: flex-start !important; gap: 8px; }
